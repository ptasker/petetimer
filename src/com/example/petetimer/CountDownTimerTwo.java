 ...
 */
public abstract class CountDownTimerTwo {
     ...
     */
    public CountDownTimerTwo(long millisOnTimer, long countDownInterval, boolean runAtStart) {
     ...
     */
    public synchronized final CountDownTimerTwo create() {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            synchronized (CountDownTimerTwo.this) {
